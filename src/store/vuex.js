...
* @Last Modified time: 2018-07-03 19:14:15
*/
...
var store = new Vuex.Store({
    ...
    getters: {
       ...
       getTotal(state) {
            ...
            state.car.forEach(item => {
                if (item.selected) {
                    // selectedGoods.productName = item.productName;
                    // selectedGoods.productPrice = item.productPrice;
                    // selectedGoods.productImgUrl = item.productImgUrl;
